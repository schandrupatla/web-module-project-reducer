...
import {addOne, applyNumber, changeOperation, clearDisplay, memoryAdd, memoryClear, memoryRelease} from './actions/index'
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton  onClick={handleMemoryRelease} value={"MR"}/>
              <CalcButton onClick={handleMemoryClear} value={"MC"}/>
            </div>

            <div className="row">
             {/* <CalcButton onClick={handleChanges()} value={1}/>  */}
              {/* <CalcButton name ="calcButton1" onClick={()=>{dispatch(applyNumber(1))}} value={1}/> */}
