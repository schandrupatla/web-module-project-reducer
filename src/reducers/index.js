import { ADD_ONE, APPLY_NUMBER, CHANGE_OPERATION, CLEAR_DISPLAY, MEMORY_ACTION , MEMORY_ADD, MEMORY_RELEASE, MEMORY_CLEAR} from './../actions';
...
const reducer = (state, action) => {
    switch(action.type) {
        ...
        case(MEMORY_RELEASE):
        return({...state, total:calculateResult(state.memory, state.total, state.operation)})
